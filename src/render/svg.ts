...
/** 一个对象类型富卡片。 */
function objectCard(n: GraphNode, r: NodeRect, cfg: LayoutConfig, sel: boolean): string {
...
/** 一个接口矮胶囊节点。 */
function interfaceCard(n: GraphNode, r: NodeRect, sel: boolean): string {
...
function edgePath(e: GraphEdge, from: NodeRect, to: NodeRect, idx: number, sel: boolean): string {
