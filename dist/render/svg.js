...
import { routeEdge, routeAnchored, toPath, polyMidpoint } from '../layout/route.js';
/** 该锚点是否为当前高亮锚点。 */
...
function objectCard(n, r, cfg, sel, hot) {
    ...
    const ports = shown
        ...
        return (`<circle class="og-port${hl('L')}" data-port="${pid}" data-prop="${pa}" data-side="L" cx="${r.x}" cy="${cy}" r="4.5"/>` +
